    ...
    <View style={{ flex: 1, backgroundColor: bgColor }}>
      ...
      >
        <View style={styles.content}>
          ...
          >
            <Animated.View
              style={[
                styles.loginButton,
                {
                  backgroundColor: loginAnim.interpolate({
                    inputRange: [0, 1],
                    outputRange: ["#888888", primaryBrand],
                  }),
                },
              ]}
            >
          ...
          <View style={styles.dividerContainer}>
            ...
            <Text style={[styles.dividerText, { color: "#666" }]}>
              OR Login with
            </Text>
            <View style={styles.dividerLine} />
          </View>
      ...
      {isSubmitting && (
        <View style={styles.overlay}>
          ...
          <Text style={[styles.overlayText, { color: primaryBrand }]}>
            Authenticating...
          </Text>
        </View>
      )}
